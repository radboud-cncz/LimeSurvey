    ...
    public function view($surveyid, $gid = null, $qid = null, $landOnSideMenuTab = 'structure')
    {
        ...
        $aData['jsData'] = [
            ...
            'i10N' => [
                ...
                'Copy question' => gT('Copy question'),
                ...
                'Some example answer option' => gT('Some example answer option'),
                'Delete' => gT('Delete'),
                ...
                'Question overview' => gT('Question overview'),
                'Question editor' => gT('Question editor'),
                'General Settings' => gT('General Settings'),
                'Toggle source mode' => gT('Toggle source mode'),
                'Set for all languages' => gT('Set for all languages'),
                'Condition' => gT('Condition'),
                'Add answeroption' => gT('Add answeroption'),
                'Save as labelset' => gT('Save as labelset'),
                'Name for label set' => gT('Name for label set'),
                'Multilingual entry' => gT('Multilingual entry'),
                'Question type preview' => gT('Question type preview'),
                'No label set selected' => gT('No label set selected'),
                'Title' => gT('Title'),
                'Subquestion' => gT('Subquestion'),
                'Condition' => gT('Condition'),
                'Type:' => gT('Type:'),
                'Assessment value' => gT('Assessment value'),
                'Answer option' => gT('Answer option'),
                'Confirm' => gT('Confirm'),
                'Toggle dark mode' => gT('Toggle dark mode'),
                'Label sets' => gT('Label sets'),
                'Select label set' => gT('Select label set'),
                'Sort order' => gT('Sort order'),
                'Close' => gT('Close'),
                'Select' => gT('Select'),
                'Yes' => gT('Yes'),
                'No' => gT('No'),
                'Select question type' => gT('Select question type'),
            ],
        ];
