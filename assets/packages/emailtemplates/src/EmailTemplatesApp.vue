                ...
                <div class="col-md-10 col-sm-12 ls-space margin top-5 bottom-5 scope-contains-ckeditor" id="emailtemplates--type-select-editorbody">
                    <div class="container-fluid"> 
                        ...
                        <div class="row ls-space margin top-15">
                            <div class="ls-flex-row col-12">
                                <button id="EmailTemplates--actionbutton-validateCurrentContent" class="btn btn-default" @click.prevent="validateCurrentContent"> {{"Validate ExpressionScript"|translate}} </button>
                                <button id="EmailTemplates--actionbutton-resetCurrentContent" class="btn btn-default" @click.prevent="resetCurrentContent"> {{"Reset to default"|translate}} </button>
                                <button id="EmailTemplates--actionbutton-addFileToCurrent" class="btn btn-default" @click.prevent="addFileToCurrent"> {{"Add attachment to template"|translate}} </button>
                            </div>
                        </div>
